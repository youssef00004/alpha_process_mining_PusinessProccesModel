...
# Matches Input.xlsx exactly (single source of truth)
RAW_EVENTS = [
    ...
    ("4", "Ge-5223148148-4", "2012-08-04 12:20", "Get shipping address",              "SYS2"),
    ("4", "Em-4034837963-4", "2012-08-04 12:32", "Emit invoice",                     "SYS2"),
    ("4", "Re-4180555556-4", "2012-08-08 09:41", "Receive payment",                  "SYS2"),
